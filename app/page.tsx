...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between">
      ...
      <div className="pb-8 mb-8 grid text-center lg:max-w-5xl lg:w-full lg:mb-0 lg:grid-cols-3">
        ...
        >
          ...
          USPD is 110% backed by on-chain Ether reserves. If the reserve ratio drops below 110%, USPD gets redeemed until the reserve ratio is restored.
        ...
        >
          ...
          <p className={`m-0 max-w-[30ch] text-sm opacity-50`}>
            USPD is self-issued. There are no intermediaries or custdodians. USPD cannot be frozen or seized. It&apos;s the only stablecoin you really own.
          </p>
        </div>
