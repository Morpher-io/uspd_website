                ...
                <div className="flex flex-col gap-16 mt-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div className="flex text-center items-center flex-col p-6 border rounded-lg bg-card">
                            ...
                            <h3 className="text-2xl font-heading font-bold mb-4">Transparent & Secure</h3>
                        ...
                        <div className="flex text-center items-center flex-col p-6 border rounded-lg bg-card">
                            ...
                            <h3 className="text-2xl font-heading font-bold mb-4">Yield</h3>
                            <p className="text-muted-foreground mb-6 text-lg flex-grow">
                        ...
                        <div className="flex text-center items-center flex-col p-6 border rounded-lg bg-card">
                            ...
                            <h3 className="text-2xl font-heading font-bold mb-4">Unstoppable & Accessible</h3>
                            <p className="text-muted-foreground mb-6 text-lg flex-grow">
                    ...
                    {/* Bottom section: Video and Minting */}
